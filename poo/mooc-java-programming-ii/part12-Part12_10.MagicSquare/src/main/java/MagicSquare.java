...
public class MagicSquare {
    ...
    public ArrayList<Integer> sumsOfDiagonals() {
        ...
        int firstDiagonal, secondDiagonal, factor;
        ...
        for(int i = 0; i < square.length; i++){
            for(int j = 0; j < square[i].length; j++){
                if(i == j){
                    firstDiagonal += square[i][j];
                }
                if (j == square[i].length - factor) {
                    secondDiagonal += square[i][j];
                    factor++;
                }
            }
        }
        sumOfDiagonals.add(firstDiagonal);
        sumOfDiagonals.add(secondDiagonal);
